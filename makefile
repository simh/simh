...
ATT3B2M400D = ${SIMHD}/3B2
ATT3B2M400 = ${ATT3B2M400D}/3b2_400_cpu.c ${ATT3B2M400D}/3b2_400_sys.c \
	${ATT3B2M400D}/3b2_400_stddev.c ${ATT3B2M400D}/3b2_400_mmu.c \
	${ATT3B2M400D}/3b2_400_mau.c ${ATT3B2M400D}/3b2_iu.c \
	${ATT3B2M400D}/3b2_if.c ${ATT3B2M400D}/3b2_id.c \
	${ATT3B2M400D}/3b2_dmac.c ${ATT3B2M400D}/3b2_io.c \
	${ATT3B2M400D}/3b2_ports.c ${ATT3B2M400D}/3b2_ctc.c \
	${ATT3B2M400D}/3b2_ni.c
ATT3B2M400_OPT = -DUSE_INT64 -DUSE_ADDR64 -I ${ATT3M400B2D} ${NETWORK_OPT}
...
ifneq (,$(call find_test,${ATT3B2M400D},3b2))
	$@ $(call find_test,${ATT3B2M400D},3b2) ${TEST_ARG}
endif
